...
public class appTest {
	...
	public class CounterObservable extends Counter {
		...
		public void incCount() { count++; o.setChanged(); o.notifyObservers(this);}
		public void decCount() { count--; o.setChanged(); o.notifyObservers(this);}
		public void addObserver(lev_i_Observer ob) {o.addObserver(ob);}
	}
