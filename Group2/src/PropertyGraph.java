...
{ 
	...
	Rect getBox()
	{ return new Rect(this.appGUI, (int)(_x+_w*0.4+3), _y+1, (int)(_w*0.6-8), getHeight()-2); }
	...
	public void onMousePressed()
	{
		if(this.appGUI.overRect(getBox()))
		{
			if(_frame == null)
			{
				_frame = new GraphFrame(this.appGUI, _parent, _name, _value, this);
