...
public class dg_ParticleLerp extends dg_Particle {
    ...
    public static final int lerpValue=dg_NameSpaceParticles.nsp.add("lerpValue");
    public static final int lerpSpeed=dg_NameSpaceParticles.nsp.add("lerpSpeed");
    public static final int maxAlpha=dg_NameSpaceParticles.nsp.add("maxAlpha");
    public static final int alpha=dg_NameSpaceParticles.nsp.add("alpha");
    public static final int newAlpha=dg_NameSpaceParticles.nsp.add("newAlpha");
