...
public class ColorGradient
{
	...
	int get(float pos)
	{
		...
		if(_useLookupTable)
		{
			int i = appGUI.constrain(appGUI.floor(pos*_lookupTable.length), 0, _lookupTable.length-1);
		...
		case 0:
		default:
			return this.appGUI.lerpColor(leftValue, rightValue, (1-appGUI.cos(amt*appGUI.PI))/2);
		case 1:
