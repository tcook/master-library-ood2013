...
public class PropertySliderInteger extends PropertySlider
{
	...
	PropertySliderInteger(appGUI appGUI, String name, MinyInteger value, int mini, int maxi)
	{
		super(appGUI, name);
		this.appGUI = appGUI;    
		_value = value;
	...
	void setPos(float v) 
	{ _value.setValue(appGUI.round(appGUI.constrain(_mini+v*(_maxi-_mini), _mini, _maxi))); }
