package processing.test.mydollar;
...
public class MyDollar extends PApplet {
...
class Recognizer
{
  ...
  Recognizer( )
  {
    ...
    // check
    Point [] point4 = {
      new Point(91, 185), new Point(93, 185), new Point(95, 185), new Point(97, 185), new Point(100, 188), 
    ...
    // caret
    Point [] point5 = {
      new Point(79, 245), new Point(79, 242), new Point(79, 239), new Point(80, 237), new Point(80, 234), 
    ...
    // question
    Point [] point6 = {
      new Point(104, 145), new Point(103, 142), new Point(103, 140), new Point(103, 138), new Point(103, 135), 
...
public Point [] TranslateToOrigin( Point [] points)
{
  ...
  public int sketchHeight() { return 250; }
}
