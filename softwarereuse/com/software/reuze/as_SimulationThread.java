...
public class as_SimulationThread extends Thread implements Comparable<as_SimulationThread> {
	...
	static class Request implements Comparable<Request> {
		...
		public Request(as_SimulationThread owner) {this.owner=owner;}
	...
	public int compareTo(as_SimulationThread arg0) {
		...
		if (t1.eventTime<t2.eventTime) return -1;
		if (t1.eventTime==t2.eventTime)return t1.priority<t2.priority?-1:(t1.priority>t2.priority?1:0); 
		return +1;
	}
	public void exit() {
